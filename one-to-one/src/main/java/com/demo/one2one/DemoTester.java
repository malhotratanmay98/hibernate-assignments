...
//We have used cascading, hence when parking objects are saved, 
//employee objects will be saved too consequently
...
//		session.save(employee5);
		...
		List<Parking>parkings=session.createQuery("from Parking p join fetch p.employee Employee",Parking.class).getResultList();
		System.out.println("------------------------------------");
